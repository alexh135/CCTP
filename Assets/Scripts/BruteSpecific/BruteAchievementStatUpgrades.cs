...
public class BruteAchievementStatUpgrades : MonoBehaviour
{
    // public references to other scripts
    public XPBar xPBar;
    public BruteClass bruteClass;
    public BruteAchievementUnlock achievementUnlocks;
    ...
    public void KillAchievementStatUpgrades()
    {
        ...
        if (enemyController.kills == 10)
        {
            ...
            bruteClass.Strength = bruteClass.Strength + 1;
        }
    ...
    public void ExplorerAchievementStatUpgrades()
    {
        ...
        if (explorerRegions.regionsExplored == 2)
        {
            ...
            bruteClass.Stamina = bruteClass.Stamina + 1;
        }
    ...
    public void maxCompletionStatUpgrades()
    {
        ...
        if (achievementUnlocks.maxCompletion)
        {
            ...
            bruteClass.Stamina = bruteClass.Stamina + 4;
            bruteClass.Health = bruteClass.Health + 4;
            bruteClass.Strength = bruteClass.Strength + 4;
            bruteClass.Speed = bruteClass.Speed + 4;
            bruteClass.Intellect = bruteClass.Intellect + 4;
        }
    }
}
